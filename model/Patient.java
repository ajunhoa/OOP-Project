        ...
        public class Patient extends User {
            ...
            public void viewMedicalRecord() {
                if (medicalRecord != null) {
                    medicalRecord.displayMedicalRecord();  // Delegate the display to MedicalRecord class
                } else {
            ...
            public void setMedicalRecord(MedicalRecord medicalRecord) {
                this.medicalRecord = medicalRecord; 
                    // Debug print to verify if the medical record is set correctly
                if (medicalRecord != null) {
                    System.out.println("Medical record set for patient: " + getName());
                    System.out.println(medicalRecord.toString()); // This will print the medical record details
                } else {
